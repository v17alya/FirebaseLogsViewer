import { MockFirebaseService } from '../utils/mock-data.js';
import { FilterPanel } from '../components/FilterPanel.js';
import { LogsTable } from '../components/LogsTable.js';
import { ExportPanel } from '../components/ExportPanel.js';

/**
 * Main application class with mock data
 */
class FirebaseLogsViewerMock {
  constructor() {
    this.firebaseService = new MockFirebaseService();
  ...
  async loadLogs() {
    try {
      ...
      this.updateStatus(`Loaded ${logs.length} mock logs`);
    } catch (error) {
  ...
  async onFiltersChange(filters) {
    ...
    try {
      ...
      this.updateStatus(`Found ${logs.length} mock logs matching filters`);
    } catch (error) {
